      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-slate-500 text-sm">
            {searchQuery ? filteredProjects.length : (totalCount > 0 ? totalCount : filteredProjects.length)} project
            {(searchQuery ? filteredProjects.length : (totalCount > 0 ? totalCount : filteredProjects.length)) !== 1 ? "s" : ""}
            ...
            {hasMore && !searchQuery && (
              <div className="flex justify-center mt-12">
                ...
                >
                  ...
                  Load More Projects
                  {totalCount > 0 && (
                    <span className="ml-2 text-emerald-200">({projects.length}/{totalCount})</span>
                  )}
                </button>
              </div>
            )}
